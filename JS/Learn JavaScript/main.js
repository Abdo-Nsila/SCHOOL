...
choix = [["Morocco","Brasile","Argentine","Italy"],["list-style","text_decoration","text-align","font-size"],["Wahmani","Wahmane","GiGACHAD","TheKing"],["insert()","sort()","join()","rstrip()"],["Rifai","Oumada","Arrabane","Ait Lhsen"],["nameAlgo Var Début Fin","Début Var Fin","Const Début Fin","Var Début Const Fin"],["Windows XP","Windows 7","Last version","Windows 11"],["0.001 m/s","80 km/h","speed of light","import turtle"],["char()","ord()","code()","strAscii()"],["amazon","Marjan","Carefoure","Lkhmiss"],["C#","Python","C","C++"],["13","12","20","10"],["Midlle","Good","Insane","I'am Noob:)"]] ;
coreect_answer = ["Argentine","text_decoration","GiGACHAD","sort()","Arrabane","nameAlgo Var Début Fin","Last version","0.001 m/s","ord()","Lkhmiss","C","13","I'am Noob:)"] ;
